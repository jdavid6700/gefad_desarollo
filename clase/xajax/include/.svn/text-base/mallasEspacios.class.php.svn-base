...
function caracteristicasEspacio($id_espacio,$id_div){
     ...
     //Rescata el valor de la configuracion
       ...
       $busqueda="SELECT * FROM ";
       $busqueda.=$configuracion["prefijo"]."espacio_academico ";
       $busqueda.="WHERE id_espacio=".$id_espacio;
       
       $resultado=$acceso_db->ejecutarAcceso($busqueda,"busqueda");

       #Genera la div que se va a mostrar 
       $cadena_html="<table width='100%' class='cuadro_plano'><tr><td>".$resultado[0][3]."</td></tr></table>";
