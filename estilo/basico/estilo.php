...
--background-image: url(<?PHP echo $configuracion['host'] . $configuracion['site'] . $configuracion['estilo'] . '/' . $mi_tema ?>/banner.png);
}
...
td.seccion_B
{
width:<?PHP echo $configuracion["tamanno_gui"] * (0.01) ?>%;
border: 0px;
...
{
width:<?PHP echo $configuracion["tamanno_gui"] * (0.1) ?>%;
border: 0px;
border-collapse: collapse;
border-spacing: 0px;
}
...
text-align: center; font-family: Tahoma, Arial, Geneva, sans-serif; color:#797979;
font-size: 13;
...
{
width: 100%;
height:15px;display:inline-block;text-align:left; font-size: 11px;
}
