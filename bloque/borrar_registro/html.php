					...
					<tbody>
						<tr class="bloquelateralencabezado">
							<td valign="middle" align="right" width="10%"><img
								...
								border="0" /></td>
							<td valign="middle" align="left">Eliminar un registro del sistema
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<table border="0" cellpadding="10" cellsapcing="0">
									<tbody>
										<tr class="bloquecentralcuerpo">
											<td>Confirma la eliminaci&oacute;n de <b><? echo $borrar_nombre ?>
											</b> del sistema. Tenga en cuenta que este cambio no
												podr&aacute;&nbsp; deshacerse.<br>
											</td>
										</tr>
										<tr class="bloquecentralcuerpo">
											<td align="center"><? echo $opciones ?>
												<hr style="width: 100%; height: 2px;"> En algunas ocasiones
												borrar un registro puede implicar la eliminaci&oacute;n de
												todos sus datos asociados.</span></small>
											</div>
												<br></td>
										</tr>
									</tbody>
