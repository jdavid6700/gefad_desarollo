...
<form enctype='multipart/form-data' method='POST' action='index.php'
	...
	<table width='80%' class='formulario' align='center'>
		<tr class='bloquecentralcuerpobeige'>
			<td colspan='3'><hr class='hr_subtitulo' /> <? if(!$registro)		
		...
		<tr>
			...
			<td><input type='text' name='nombres' value='<? echo $nombres ?>'
				size='40' maxlength='255' tabindex='<? echo $tab++ ?>'
		...
		<tr>
			...
			<td><input type='text' name='apellidos' value='<? echo $apellidos ?>'
				size='40' maxlength='255' tabindex='<? echo $tab++ ?>'
				onKeyPress="return solo_texto_sin_esp(event)">
			</td>
		</tr>
		<tr>
			...
			<td><input type='text' name='identificacion'
				value='<? echo $identificacion ?>' size='40' maxlength='15'
				tabindex='<? echo $tab++ ?>'
		...
		<tr>
			...
			<td><input type='text' name='telefono' value='<? echo $telefono ?>'
				size='40' maxlength='50' tabindex='<? echo $tab++ ?>'
		...
		<tr>
			...
			?><font color="red">*</font><span
				onmouseover="return escape('<? echo $texto_ayuda?>')">Extension:</span>
			</td>
			<td><input type='text' name='ext' value='<? echo $telefono ?>'
				size='40' maxlength='50' tabindex='<? echo $tab++ ?>'
				onKeyPress="return solo_numero(event)">
			</td>
		</tr>
		<tr>
			...
			<td><input type='text' name='correo' value='<? echo $correo ?>'
				size='40' maxlength='100' tabindex='<? echo $tab++ ?>'>
			</td>
		</tr>
		<tr>
			<td width='30%'><?
			...
			<td><input type='text' name='celular' value='<? echo $celular ?>'
				size='40' maxlength='15' tabindex='<? echo $tab++ ?>'
				onKeyPress="return solo_numero_sin_slash(event)" />
			</td>
		</tr>
		<tr>
			...
			?><font color="red">*</font><span
				onmouseover="return escape('<? echo $texto_ayuda?>')">Dependencia:</span>
			</td>
			<td><?	//Evaluamos el rol del usuario actual en el sistema, si es administrador general no tiene 
		...
		<tr>
			...
			?><font color="red">*</font><span
				onmouseover="return escape('<? echo $texto_ayuda?>')">Área:</span>
			</td>
			<td><?
			/*        if(!$registro)
			 { ?><div id="areaDep"><?
		...
		<tr>
			...
			?><font color="red">*</font><span
				onmouseover="return escape('<? echo $texto_ayuda?>')">Rol:</span>
			</td>
			<td><?	//Evaluamos el rol del usuario actual en el sistema, si es administrador general no tiene 
			/*	//restricciones en roles; si NO es administrador general, no puede crear usuarios con rol Administrador
			//general
		...
		<tr>
			...
			?><font color="red">*</font><span
				onmouseover="return escape('<? echo $texto_ayuda?>')">Fecha
					Inactivaci&oacute;n:</span>
			</td>
			<td><script
					src="<? echo $configuracion["host"].$configuracion["site"].$configuracion["javascript"] ?>/funciones.js"
					type="text/javascript" language="javascript"></script> <input
				type='text' name='fecha_inactiva'
				value='<? if (!$registro){echo "31/12/".date("Y");} 
                                                                                   else {list($d,$m,$a)=explode("-",$registro[0]['F_FIN']);
                                                                                         echo $a."/".$m."/".$d;}  ?>'
				size='12' maxlength='25' tabindex='<? echo $tab++ ?> '
				readonly="readonly" /> <a
				href="javascript:muestraCalendario('<? echo $configuracion["host"].$configuracion["site"].$configuracion["javascript"] ?>','<? echo $this->formulario;?>','fecha_inactiva')">
					<img border="0"
					src="<? echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/cal.png"?>"
					width="24" height="24" alt="DD-MM-YYYY">
			</a>
			</td>
		</tr>
	</table>
	<table align='center'>
		<tr align='center'>
			<td colspan='2' rowspan='1'><input type='hidden' name='usuario'
				value='<? echo (isset($_REQUEST["usuario"])?$_REQUEST["usuario"]:'') ?>'>
				<input type='hidden' name='action' value='admin_usuario'> <input
				type='hidden' name='opcion' value='nuevo'> <!--<input value="Guardar" name="aceptar" tabindex='?= $tab++ ?>' type="button" onclick="if(?= $this->verificar; ?>){?echo $this->formulario?>.contrasena.value = hex_md5(?echo $this->formulario?>.contrasena.value);?echo $this->formulario?>.reescribir_contrasena.value = hex_md5(?echo $this->formulario?>.reescribir_contrasena.value);document.forms['? echo $this->formulario?>'].submit()}else{false}"/>-->
				<input value="Guardar" name="aceptar" tabindex='<?= $tab++ ?>'
				type="button"
						...
						<td>
							<table class='contenidotabla'>
								<tr>
									...
									<td class='cuadro_plano '><? echo  $datos_usuario[0]['IDENT']?>
									</td>
								</tr>
								<tr>
									<td class='cuadro_plano centrar ancho10'>Nombre(s):</td>
									<td class='cuadro_plano '><? echo  $datos_usuario[0]['NOMBRE']?>
									</td>
								</tr>
								<tr>
									<td class='cuadro_plano centrar ancho10'>Apellido(s):</td>
									<td class='cuadro_plano '><? echo  $datos_usuario[0]['APELLIDO']?>
									</td>
								</tr>
								<tr>
									<td class='cuadro_plano centrar ancho10'>Usuario:</td>
									<td class='cuadro_plano '><? echo  $datos_usuario[0]['NICK']?>
									</td>
								</tr>
								<tr>
									<td class='cuadro_plano centrar ancho10'>Correo:</td>
									<td class='cuadro_plano '><? echo  $datos_usuario[0]['MAIL']?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class='cuadro_plano '>
										...
										<form enctype='multipart/form-data' method='POST'
											action='index.php' name='<? echo $this->formulario;?>'>
											<? 
										...
										?>
											...
											<input type='hidden' name='cod_usuario'
												value='<? echo $cod_usuario?>'> <input type='hidden'
												name='dato' value='<? echo $dato?>'> <input type='hidden'
												name='action' value='admin_usuario'> <input type='hidden'
												name='opcion' value='cambiar_estado'> &nbsp;&nbsp; <input
												value="Cambiar estado" name="aceptar"
												tabindex='<? echo  $tab++; ?>' type="button"
												onclick="if(confirm('Señor usuario confirma que desea cambiar el estado del usuario?')){document.forms['<? echo $this->formulario?>'].submit()}">
											<input name='cancelar' value='Cancelar' type='submit'>
								...
								<tr>
									...
									<td align='center' width='10%' class='cuadro_plano' colspan='2'>
										...
										href='<?
                                                                                    ...
                                                                                    ?>'><img
											width='24' heigth='24'
											src='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/editar.png";?>'
											alt='Editar este registro' title='Editar este registro'
											border='0' /> <a
											href='<?
                                                                                    ...
                                                                                    ?>'><img
												width='24' heigth='24'
												src='<? echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/boton_borrar.png"?>'
												alt='Desactivar el registro' title='Desactivar el registro'
												border='0' /> </a> <?php }
                                                                                else {?>
											<img width='24' heigth='24'
											src='<?php echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/button_cancel.png";?>'
											alt='Registro Inactivo' title='Registro Inactivo' border='0' />
											<?php }?>
...
<form enctype='multipart/form-data' method='POST' action='index.php'
	...
	<table align='center'>
		<tr align='center'>
			<td colspan='2' rowspan='1'><input type='hidden' name='usuario'
				value='<? echo $id_admin; ?>'> <input type='hidden'
				name='cod_usuario' value='<? echo $_REQUEST["cod_usuario"]; ?>' /> <input
				type='hidden' name='action' value='admin_usuario' /> <? if (!$registro){?>
				<input type='hidden' name='opcion' value='nuevoRol' /> <?} else {?>
				<input type='hidden' name='id_area2'
				value='<? echo $registro[0]['ID_AREA'];?>' /> <input type='hidden'
				name='id_rol2' value='<? echo $registro[0]['ID_ROL'];?>' /> <input
				type='hidden' name='opcion' value='editarRol' /> <?}
				?> <input value="Guardar" name="aceptar" tabindex='<?= $tab++ ?>'
				type="button"
				onclick="if(<?= $this->verificar; ?>){document.forms['<? echo $this->formulario?>'].submit()}else{false}" />
				<input name='cancelar' value='Cancelar' type='submit'
	...
	<table align='center'>
		<tr align='center'>
			<td colspan='2' rowspan='1'><input type='hidden' name='usuario'
				value='<? echo (isset($_REQUEST["usuario"])?$_REQUEST["usuario"]:''); ?>'>
				<input type='hidden' name='action' value='admin_usuario'> <input
				type='hidden' name='opcion' value='cambiar_clave'> <input
				value="Guardar" name="aceptar" tabindex='<?= $tab++ ?>'
				type="button"
