				...
				<table align="center" border="0" cellpadding="5" cellspacing="2"
					...
					<tr class="bloquelateralcuerpo">
						<td class="cuadro_simple">
							<form enctype='multipart/form-data,text/plain' method='POST'
								action='index.php' name='adminUsuario'>
								<table width="100%" border="1">
									...
									<tr class="texto_subtitulo">
										<td class="cuadro_simple"><input type='radio'
											name='criterio_busqueda' value='NOMBRE'
											<? if (!$_REQUEST['criterio_busqueda'] OR $_REQUEST['criterio_busqueda']=='NOMBRE') {?>
											CHECKED <? }?>> Nombre<br> <input type='radio'
											name='criterio_busqueda' value='ID'
											<? if ($_REQUEST['criterio_busqueda']=='ID') {?> CHECKED
											<? }?>> Identificación<br>
										</td>
									</tr>
									<tr class="texto_subtitulo">
										<td class="cuadro_simple"><input type='text' name='clave'
											size="12" maxlength='50' <? if(isset($_REQUEST['clave'])){?>
											value='<? echo $_REQUEST['clave'];?>' <? }?>
											onKeyPress="return solo_alfanumerico(event)">
										</td>
									</tr>

									<tr>
										<td class="cuadro_simple"><input type='hidden' name='action'
											value='admin_usuario'> <input type='hidden' name='opcion'
											value='consultar'> <input type='hidden' name='opcion'
											value='mostrar'>
											<center>
												<input name='consultar' value='Consultar' type='submit'><br>
											</center>
										</td>
									</tr>
								</table>
