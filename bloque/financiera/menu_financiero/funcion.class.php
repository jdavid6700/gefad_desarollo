...
<table align="center" class="tablaMenu" float="bottom">
	<tbody>
		<tr>
			<td>
				<table align="center" border="0" cellpadding="5" cellspacing="2"
					class="bloquelateral_2" width="100%" background-color='white' >
					<tr class="bloquelateralcuerpo">
						...
						<td class="cuadro_simple">
                                                    <a href="http://10.20.0.56:7779/forms/frmservlet?config=pr" target="popuppr" onclick='window.open("", "popuppr", "")' > Presupuesto </a>
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td class="cuadro_simple">
						<a href="http://10.20.0.56:7779/forms/frmservlet?config=lm" target="popuplm" onclick='window.open("", "popuplm", "")' > Contabilidad </a>
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td class="cuadro_simple">
						<a href="http://10.20.0.56:7779/forms/frmservlet?config=ogt" target="popupogt" onclick='window.open("", "popupogt", "")' > Tesorería </a>
						</td>
					</tr>                                        
					<tr class="bloquelateralcuerpo">
						<td class="cuadro_simple">
						<a href="http://10.20.0.56:7779/forms/frmservlet?config=co" target="popupco" onclick='window.open("", "popupco", "")' > Contratación </a>
						</td>
					</tr>
					<tr class="bloquelateralcuerpo">
						<td class="cuadro_simple">
