...
//Clase
class bloque_formIPC extends bloque {

    private $configuracion;

    public function __construct($configuracion) {
        $this->configuracion = $configuracion;
        $this->sql = new sql_formIPC();
        $this->funcion = new funciones_formIPC($configuracion, $this->sql);
    }
...
$esteBloque = new bloque_formIPC($configuracion);
