        ...
        <form id="form" method="post" action="index.php" name='<? echo $this->formulario; ?>' onSubmit="return minDate();" autocomplete='Off'>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="fecha_con" title="*Campo Obligatorio" value="<? echo $fecha_concurrencia ?>" name="fecha_concurrencia" maxlenght="10" placeholder="dd/mm/aaaa" required='required' pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/](19|20)\d\d" onpaste="return false">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="fecha_pension" title="*Campo Obligatorio" value="<? echo $fecha_pension ?>"   name="fecha_pension"  maxlenght="10" placeholder="dd/mm/aaaa" required='required' pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/](19|20)\d\d" onpaste="return false" value="<? echo $fecha_pension ?>">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="fecha_res_pension" title="*Campo Obligatorio" value="<? echo $resol_pension_fecha ?>"  name="fecha_res_pension" maxlenght="10" placeholder="dd/mm/aaaa" required='required' pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/](19|20)\d\d" onpaste="return false" value="<? echo $resol_pension_fecha ?>">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="p1f6c" name="cp_aceptada" value="<? echo $valor_cuota ?>" title="*Campo Obligatorio" class="fieldcontent" required='required' onKeyPress='return acceptNum2(event)' placeholder="00000000.00" pattern="^[0-9]\d{3,9}(\.\d{1,2})?%?$" maxlength="11"  onpaste="return false">Mínimo 4 caracteres
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
