...
class html_formConcurrencia {
    ...
    function formularioConcurrencia($datos_historia, $datos_empleador, $datos_previsora, $datos_concurrencia) {
        ...
        <link	href="<?php echo $this->configuracion["host"] . $this->configuracion["site"] . $this->configuracion["bloques"] ?>/nomina/cuotas_partes/formConcurrencia/form_estilo.css"	rel="stylesheet" type="text/css" />
        <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
        <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script>
        <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script>
        ...
        <form id="form" method="post" action="index.php" name='<? echo $this->formulario; ?>' onSubmit="return minDate();" autocomplete='Off'>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="fecha_con" title="*Campo Obligatorio" <?php echo " " . $lectura . " " ?> name="fecha_concurrencia" maxlenght="10" placeholder="dd/mm/aaaa" required='required' pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/](19|20)\d\d" onpaste="return false">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="fecha_pension" title="*Campo Obligatorio" <?php echo " " . $lectura . " " ?>  name="fecha_pension"  maxlenght="10" placeholder="dd/mm/aaaa" required='required' pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/](19|20)\d\d" onpaste="return false" value="<? echo $fecha_pension ?>">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="res_pensión" title="*Campo Obligatorio" <?php echo " " . $lectura . " " ?>  name="resolucion_pension" required='required' onKeyPress='return acceptNumLetter(event)' maxlength="12" pattern=".{1,12}." onpaste="return false" value="<? echo $resol_pension ?>">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="fecha_res_pension" title="*Campo Obligatorio" <?php echo " " . $lectura . " " ?>  name="fecha_res_pension" maxlenght="10" placeholder="dd/mm/aaaa" required='required' pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/](19|20)\d\d" onpaste="return false" value="<? echo $resol_pension_fecha ?>">
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f12" class="field n1">
                    ...
                    <div class="control capleft">
                        <div>
                            <input type="text" id="p1f12c" name="mesada" <?php echo " " . $lectura . " " ?>  title="*Campo Obligatorio" class="fieldcontent" required='required' onKeyPress='return acceptNum2(event)' maxlength="11" placeholder="00000000.00" pattern="^[0-9]\d{4,9}(\.\d{1,2})?%?$" onpaste="return false" value="<? echo $valor_mesada ?>">Mínimo 4 caracteres
                        </div>
                        <div class="null"></div>
                    </div>
                    <div class="null"></div>
            ...
            <div class="formrow f1">
                <div id="p1f6" class="field n1">
                    <div class="caption capleft alignleft">
                        <label class="fieldlabel" for="observacion"><span><span class="pspan arial" style="text-align:left;font-size:14px;"><span class="ispan" style="color:#9393FF" > Observaciones</span></span></span></label>
                        <div class="null"></div>
                    </div>
                    <div class="control capleft">
                        <div>
    ...
    function formularioConcurrenciaModificar($datos_historia, $datos_empleador, $datos_previsora, $datos_concurrencia) {
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#fecha_acto_adm").datepicker('setDate', '<?php echo $factoadm ?>');
            });
            ...
            $(document).ready(function () {
                ...
                $("#fecha_res_pension").datepicker('setDate', '<?php echo $resol_pension_fecha ?>');
            });
            ...
            $(document).ready(function () {
                ...
                $("#fecha_pension").datepicker('setDate', '<?php echo $fecha_pension ?>');
            });
        </script>
        ...
        <script language = "Javascript">
            ...
            function echeck(str) {
                ...
                var min = new Date('<?php echo $f_fecha_anio ?>,<?php echo $f_fecha_mes ?>,<?php echo $f_fecha_dia ?>,');
                var y = str.substring(6);
                var m3 = str.substring(3, 5);
                var m2 = m3 - 1;
                var m = '0' + m2;
        ...
        <form id="form" method="post" action="index.php" name='<?php echo $this->formulario; ?>' onSubmit="return minDate();" autocomplete='Off'>
            <h1>Concurrencias Aceptadas</h1>
