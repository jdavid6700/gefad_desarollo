...
function consultaGeneral($datos) {
...
<br>
<form id="<?php echo $this->formulario; ?>" method="post" action="index.php" name='<? echo $this->formulario; ?>' autocomplete='Off' onSubmit="return validate();">
    <center>

        <table class='bordered'  width ="75%" align="center">
            <tr>
                <th colspan="9" class='encabezado_registro'>INFORMACIÓN GENERAL SISTEMA</th>
                <td class='texto_elegante<?php echo '' ?> estilo_td' ></td>
            </tr>
            <tr>
                <td  class='texto_elegante2 estilo_td' align=center>&nbsp;CÉDULA AFECTADO&nbsp;</td>
                <td  class='texto_elegante2 estilo_td' align=center>&nbsp;NÚM. EMPLEADORES<br> REGISTRADOS&nbsp;</td>
                <td  class='texto_elegante2 estilo_td' align=center>&nbsp;NÚM. PREVISORES<br> REGISTRADOS&nbsp;</td>
                <td  class='texto_elegante2 estilo_td' align=center>&nbsp;NÚM. CONCURRENCIAS<BR>ACEPTADAS&nbsp;</td>
                <td  class='texto_elegante2 estilo_td' align=center>&nbsp;NÚM. COBROS GENERADOS<BR>EN EL SISTEMA (2015)&nbsp;</td>
                <td  class='texto_elegante2 estilo_td' align=center>&nbsp;NÚM. PAGOS RECIBIDOS<BR>REGISTRADOS&nbsp;</td>
            </tr>
            <tbody id="itemContainer">
                <tr>
                    ...
                    $total_cobros = 0;
                    $total_pagos = 0;
                    $total_concurrencias = 0;
                    if (is_array($datos)) {
                    foreach ($datos as $key => $value) {
                    echo "<tr>";
                    echo "<td class='texto_elegante estilo_td' style='text-align:center;'>" . $datos[$key]['cob_cedula'] . "</td>";
                    echo "<td class='texto_elegante estilo_td' style='text-align:center;'>" . $datos[$key]['num_empleadores'] . "</td>";
                    echo "<td class='texto_elegante estilo_td' style='text-align:center;'>" . $datos[$key]['num_previsores'] . "</td>";
                    echo "<td class='texto_elegante estilo_td' style='text-align:center;'>" . $datos[$key]['concurrencias_aceptadas'] . "</td>";
                    echo "<td class='texto_elegante estilo_td' style='text-align:center;'>" . $datos[$key]['cobros_generados'] . "</td>";
                    echo "<td class='texto_elegante estilo_td' style='text-align:center;'>" . $datos[$key]['recaudos_registrados'] . "</td>";
                    echo "</tr>";
                    $total_cobros = $total_cobros+$datos[$key]['cobros_generados'];
                    $total_pagos = $total_pagos+$datos[$key]['recaudos_registrados'];
                    $total_concurrencias = $total_concurrencias+$datos[$key]['concurrencias_aceptadas'];
                    }
                    } else {
                    echo "<tr>";
        ...
        <center>
            <table class='bordered'  width ="75%" >
                <tr>
                    <th colspan="10" class="subtitulo_th" style="font-size:12px;">TOTALES</th>
                </tr>
                <tr>
                    <th class='encabezado_registro' width="5%" rowspan="2">TOTAL</th>
                    <th class='subtitulo_th centrar'>CONCURRENCIAS ACEPTADAS</th>
                    <th class='subtitulo_th centrar'>COBROS GENERADOS</th>
                    <th class='subtitulo_th centrar'>PAGOS RECIBIDOS</th>
                </tr>
                <?php
                echo "<tr>";
                echo "<td class='texto_elegante estilo_td' style='text-align:center;'>".$total_concurrencias."</td>";
                echo "<td class='texto_elegante estilo_td' style='text-align:center;'>".$total_cobros."</td>";
                echo "<td class='texto_elegante estilo_td' style='text-align:center;'>".$total_pagos."</td>";
                echo "</tr>";
                ?>
            </table>
        </center>
    ...
    <div class="formrow f1">
        ...
        <div class="formrow f1">
            <div id="p1f6" class="field n1">
                ...
                <div class="control capleft">
                    <div>
                        <input type="text" id="p1f7c" title="*Campo Obligatorio" name="medio_pago" maxlength="150" placeholder="Medio de pago/Prescripción Cuota" class="fieldcontent" required='required' onKeyPress='return acceptNumLetter(event)' >
                    </div>
