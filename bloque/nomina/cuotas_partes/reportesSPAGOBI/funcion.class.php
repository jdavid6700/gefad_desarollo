...
class funciones_estadoCuenta extends funcionGeneral {
    ...
    function mostrarReporteContraloria() {
    	
    	$cadena_sql = $this->sql->cadena_sql($this->configuracion, $this->acceso_db, "consultarDBMySQLPagina", $_REQUEST);
    	$datos_reporte = $this->ejecutarSQL($this->configuracion, $this->acceso_db, $cadena_sql, "busqueda");
    	
    	$this->html_estadoCuenta->reporteContraloria($datos_reporte);
    }
