		...
		{	
			...
			case "aprobar_solicitud_pago":
				...
				$cadena_sql=" DELETE ";
                        ...
                        case "datos_rubro":
                                $cadena_sql=" SELECT DISTINCT RB.INTERNO cod_interno,RB.DESCRIPCION nom_rubro ";
                                $cadena_sql.=" FROM PR.PR_RUBRO RB ";
                                //$cadena_sql.=" INNER JOIN PR.PR_APROPIACION APR ";
                                //$cadena_sql.=" ON APR.VIGENCIA=RB.VIGENCIA ";
                                //$cadena_sql.=" AND APR.RUBRO_INTERNO = RB.INTERNO ";
                                $cadena_sql.=" WHERE RB.INTERNO='".$variable['interno']."'";
                                $cadena_sql.=" AND RB.VIGENCIA='".$variable['vigencia']."'";
                                //$cadena_sql.=" AND APR.CODIGO_UNIDAD_EJECUTORA =";
                                $cadena_sql.=" ORDER BY nom_rubro ";
                                break;
