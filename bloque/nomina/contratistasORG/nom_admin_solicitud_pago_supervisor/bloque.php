...
/*--------------------------------------------------------------------------------------------------------------------------
* @subpackage		bloqueAdminSolicitudPagoSupervisor
* @package		bloques
...
//Clase
class bloqueAdminSolicitudPagoSupervisor extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql = new sql_adminSolicitudPagoSupervisor();
 		$this->funcion = new funciones_adminSolicitudPagoSupervisor($configuracion, $this->sql);
	...
	{		
		...
		{ 
                        ...
                        case "consultarSolicitudPago":
                                $this->funcion->consultar();
                                break;
			
                        case "consultarDetallesSolicitudPago":
                                $this->funcion->consultarListadoDetalles();
                                break;
			
                        case "revisarCumplidosAprobados":
                                $this->funcion->revisarCumplidosAprobados();
                                break;
				...
				break;
                        ...
                        case 'revisar_cordis':
		  		$this->funcion->revisarCordisSolicitud();
				break;
                      
                        case 'guardar_cordis':
		  		$this->funcion->guardarCordisSolicitud();
				break;
...
$esteBloque = new bloqueAdminSolicitudPagoSupervisor($configuracion);
