...
/*    function mostrarNovedades($datos_novedad){
     ...
     * @param String $estilo 
     */	
    function form_acta($tipo,$datos_contrato,$datos_acta, $datos_contratista,$tema='',$estilo='')
	{
		$indice=$this->configuracion["host"].$this->configuracion["site"]."/index.php?";
		...
		$this->verificar .= "&&control_vacio(".$this->formulario.",'facta')";
		$this->verificar .= "&&seleccion_valida(".$this->formulario.",'id_tipo')";
                $this->verificar .= "&&seleccion_valida(".$this->formulario.",'regimen')";
                $this->verificar .= "&&seleccion_valida(".$this->formulario.",'declarante')";
                $this->verificar .= "&&seleccion_valida(".$this->formulario.",'pensionado')";
                $this->verificar .= "&&seleccion_valida(".$this->formulario.",'pasante')";
                
                $cod_contrato=(isset($datos_contrato[0]['NUM_CONTRATO'])?$datos_contrato[0]['NUM_CONTRATO']:'');
                $interno_oc=(isset($datos_contrato[0]['INTERNO_OC'])?$datos_contrato[0]['INTERNO_OC']:'');
                $vigencia_contrato=(isset($datos_contrato[0]['VIGENCIA'])?$datos_contrato[0]['VIGENCIA']:'');
                $cantidad_dias=(isset($datos_contrato[0]['CANTIDAD_DIAS'])?$datos_contrato[0]['CANTIDAD_DIAS']:'');
                //fechas q se encuentran almacenadas
                $f_inicial=(isset($datos_acta[0]['aci_fecha_inicio'])?$datos_acta[0]['aci_fecha_inicio']:'');
                $f_final=(isset($datos_acta[0]['aci_fecha_finalizacion'])?$datos_acta[0]['aci_fecha_finalizacion']:'');
                $f_firma=(isset($datos_acta[0]['aci_fecha_firma'])?$datos_acta[0]['aci_fecha_firma']:'');
                $tipo_nomina=(isset($datos_acta[0]['aci_cno_codigo'])?$datos_acta[0]['aci_cno_codigo']:'-1');
                
                //aspectos del contratista q se encuentran almacenados
                $regimen=(isset($datos_contratista[0]['con_regimen_comun'])?$datos_contratista[0]['con_regimen_comun']:'-1');
                $pasante=(isset($datos_contratista[0]['con_pasante'])?$datos_contratista[0]['con_pasante']:'-1');
                $declarante=(isset($datos_contratista[0]['con_declarante'])?$datos_contratista[0]['con_declarante']:'-1');
                $pensionado=(isset($datos_contratista[0]['con_pensionado'])?$datos_contratista[0]['con_pensionado']:'-1');
                
                $lista_tipo_nomina=$this->html->cuadro_lista($tipo,'id_tipo',$this->configuracion,$tipo_nomina,0,FALSE,$tab++,'id_tipo');
                $opciones[0][0] = "NO";
                $opciones[0][1] = "NO";
                $opciones[1][0] = "SI";
                $opciones[1][1] = "SI";
                $lista_regimen = $this->html->cuadro_lista($opciones,'regimen',$this->configuracion,$regimen,0,FALSE,$tab++,'regimen');
                $lista_declarante = $this->html->cuadro_lista($opciones,'declarante',$this->configuracion,$declarante,0,FALSE,$tab++,'declarante');
                $lista_pensionado =$this->html->cuadro_lista($opciones,'pensionado',$this->configuracion,$pensionado,0,FALSE,$tab++,'pensionado');
                $lista_pasante = $this->html->cuadro_lista($opciones,'pasante',$this->configuracion,$pasante,0,FALSE,$tab++,'pasante');
		...
		<form enctype='multipart/form-data' method='POST' action='index.php' name='<? echo $this->formulario;?>'>
                    ...
                    <table width='90%' class="bordered" >
                        <?
				echo "<th colspan='2'>Registrar Acta de inicio</th>";
			?>
                        <tr >
                                <td colspan="2">
                                                ...
                                                <td colspan="5">
                                                    <? 
                                                        if ($f_inicial && $f_final){
                                                            echo "Tiene registradas las siguientes fechas: ";
                                                            echo "<br>Fecha inicio: ".$f_inicial;
                                                            echo "<br>Fecha finalización: ".$f_final;
                                                            echo "<br>Cantidad días del contrato: ".$cantidad_dias;
                                                            
                                                            echo "<br><br>Por favor diligencie información faltante";
                        ...
                        <tr>
                                ...
                                <td colspan="2">
                                    <input name="finicial" type="text" id="finicial" size="15" value="<? echo $f_inicial?>" readonly="readonly"/>
                        ...
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        ...
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Fecha Finalización:</span>
                                </td>
                                <td colspan="2">
                                    <input name="ffinal" type="text" id="ffinal" size="15" value="<? echo $f_final?>" readonly="readonly"/>
                        ...
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        $texto_ayuda = "<b>Fecha firma.</b><br>Fecha firma del acta- formato AAAA-MM-DD. ";
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Fecha firma del acta:</span>
                                </td>
                                <td colspan="2">
                                    <input name="facta" type="text" id="facta" size="15" value="<? echo $f_firma?>" readonly="readonly"/>
                                    <input align="center"type=image src="<? echo $this->configuracion['site'] . $this->configuracion['grafico']; ?>/cal.png" name="btnfacta" id="btnfacta" >
                        ...
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        $texto_ayuda = "<b>Tipo de nomina.</b><br>Seleccione una opción de la lista. ";
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Tipo de N&oacute;mina:</span>
                                </td>
                                <td>
                                        <?
                                        echo $lista_tipo_nomina;
                                        ?>
                                </td>
                        </tr>
                        <tr >
                                <td colspan="2">
                                    <table width='90%' height="45" >
                                        <tr class="tabla_alerta">
                                                <td colspan="5"><br>Aspectos del Contratista: <br></td>
                                        </tr>
                                    </table>
                                </td>
                        </tr>
                        ...
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        $texto_ayuda = "<b>Régimen Común.</b><br>SI es régimen común o NO. ";
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">R&eacute;gimen Com&uacute;n:</span>
                                </td>
                                <td>
                                        <?
                                        echo $lista_regimen;
                        ...
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        $texto_ayuda = "<b>Declarante.</b><br>Seleccione SI es declarante o NO. ";
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Declarante:</span>
                                </td>
                                <td>
                                        <?
                                        echo $lista_declarante;
                                        ?>
                                </td>
                        </tr>
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        $texto_ayuda = "<b>Pensionado.</b><br>Seleccione SI es pensionado o NO. ";
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Pensionado:</span>
                                </td>
                                <td>
                                        <?
                                        echo $lista_pensionado;
                                        ?>
                                </td>
                        </tr>
                        <tr>
                                <td width='25%' class="texto_elegante estilo_td"><?
                                        $texto_ayuda = "<b>Pasante.</b><br>Seleccione SI es pasante o NO. ";
                                        ?><font color="red" >*</font>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Pasante:</span>
                                </td>
                                <td>
                                        <?
                                        echo $lista_pasante;
                        ...
                        <tr align='center'>
                                <td colspan='2' rowspan='1'>
                                    <br>
                                        ...
                                        <input type='hidden' name='action' value='nom_admin_acta_inicio'>
