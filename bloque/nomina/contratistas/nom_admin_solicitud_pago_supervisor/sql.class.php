	...
	function cadena_sql($configuracion,$conexion, $opcion,$variable="")
	{
		...
		{	
				...
				$cadena_sql=" SELECT CDP.NUMERO_DISPONIBILIDAD,";
                                ...
                                $cadena_sql.=" SOLCDPRUBRO.ID_SOL_CDP,";
                                ...
                                $cadena_sql.=" INNER JOIN CO.CO_SOL_CDP_RUBRO SOLCDPRUBRO ON CDP.VIGENCIA=SOLCDPRUBRO.VIGENCIA AND SOLCDPRUBRO.NUMERO_CDP=CDP.NUMERO_DISPONIBILIDAD AND TRIM(SOLCDPRUBRO.ESTADO_CDP)='APROBADO'";
                                $cadena_sql.=" INNER JOIN CO.CO_SOL_CDP SOLCDP ON CDP.VIGENCIA=SOLCDP.VIGENCIA AND SOLCDPRUBRO.ID_SOL_CDP=SOLCDP.ID_SOL_CDP";
				...
				$cadena_sql=" SELECT cum_id             AS id,";
                        ...
                        case "insertar_solicitud_pago":
                                ...
                                $cadena_sql.="'".$variable['id_tipo_nomina']."'";
                                $cadena_sql.=" )";
