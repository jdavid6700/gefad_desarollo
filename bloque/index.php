...
<body>
	<table align="center" width="600px" cellpadding="7">
		<tr>
			<td bgcolor="#fffee1"><h1>Acceso no autorizado.</h1>
			</td>
		</tr>
		<tr>
			<td><h3>
					Se ha creado un registro de acceso ilegal desde la
					direcci&oacute;n: <b><? echo $proxy_ip ?>
					</b>.
				</h3>
			</td>
		</tr>
		...
		<tr>
			<td style="font-size: 12;">
				<hr> Ambiente de desarrollo para aplicaciones web.<br>Software
				amparado por licencia GPL. Copyright (c) 2004-2006.<br> Universidad
				Distrital Francisco Jos&eacute; de Caldas. - Paulo Cesar Coronado
			</td>
		</tr>
	</table>
</body>
