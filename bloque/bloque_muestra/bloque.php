...
class bloqueregistroParticipante extends bloque
{
	...
	{
		$this->ruta=$configuracion["raiz_documento"].$configuracion["bloques"]."/registro_participante/";

                $this->formulario="registro_participante";
                
                $this->funcion=new funcionregistroParticipante($configuracion);
                $this->sql=new sqlregistroParticipante();
                $this->frontera=new fronteraregistroParticipante();
...
if(isset($lenguaje)){
    $esteBloque=new bloqueregistroParticipante($configuracion,$lenguaje);
}else{
    $esteBloque=new bloqueregistroParticipante($configuracion);
}
