...
if(OLud('printtext'))var ol_printtext='Imprimir';
if(OLud('printbuttontext'))var ol_printbuttontext='Imprimir';
if(OLud('printtitle'))var ol_printtitle="Click para Imprimir";
...
+o3_printtype+'; charset='+o3_printcharset+'" /><title>Imprimir</title>'
+(o3_printcssfile?'KAREN KAREN KARENKSDFJJJJJJkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk<link rel="stylesheet" type="text/css" href="'+o3_printcssfile+'" />':'')
