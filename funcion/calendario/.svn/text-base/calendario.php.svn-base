...
function mostrar_calendario($mes,$ano){
	...
	echo "<script>alert(muestra calendario);</script>";
	...
	echo "<a style=color:#0038F2;text-decoration:none href=index_cal.php?".$parametros_formulario."&nuevo_mes=".$mes_anterior."&nuevo_ano=".$ano_anterior."&formulario=".$_REQUEST['formulario']."&nomcampo=".$_REQUEST['nomcampo'].">&lt;&lt;</a></td>";
	...
	echo "<a style=color:#0038F2;text-decoration:none href=index_cal.php?".$parametros_formulario."&nuevo_mes=".$mes_siguiente."&nuevo_ano=".$ano_siguiente."&formulario=".$_REQUEST['formulario']."&nomcampo=".$_REQUEST['nomcampo'].">&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
...
echo '
	...
	<tr><form action="index_cal.php?' . $parametros_formulario . '" method="POST">
		...
		<input type="hidden" name="nomcampo" value="'.$_REQUEST["nomcampo"].'">';
echo '
...
echo '
	...
	<tr>
	    <td colspan="2" align="center"><input type="Submit" value="[ Buscar Mes - A&ntilde;o ]" style="width:165; cursor:pointer"></td>
	</tr>
	</table><br>
